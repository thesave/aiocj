 ...
 * </p>
 * <ul>
 *   <li>{@link org.aioc.impl.SumExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SumExpressionImpl extends MinimalEObjectImpl.Container implements SumExpression
{
  ...
  {
    return AiocPackage.Literals.SUM_EXPRESSION;
  }
  ...
  public EList<EObject> getChildren()
  {
    if (children == null)
    {
      children = new EObjectContainmentEList<EObject>(EObject.class, this, AiocPackage.SUM_EXPRESSION__CHILDREN);
    }
    return children;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AiocPackage.SUM_EXPRESSION__CHILDREN:
